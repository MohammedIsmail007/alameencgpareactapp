...
const Mechsem6r2020 = () => {
  ...
  const fetchStudentData = async (regno) => {
    ...
    try {
      const response = await axios.get(
        `https://alameencgpareactappserver.onrender.com/csesem5/${regno}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://alameencgpareactappserver.onrender.com/csesem6",
        data
      );
                ...
                <div className="justify-center flex flex-wrap p-3  gap-3">
                  ...
                  <table className="table-bordered border-2 rounded-sm gap-5 bg-white text-center">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th>Design of Transmission Systems</th>
                        <th>3</th>
                      ...
                      <tr>
                        <th>Non-Destructive Testing and Evaluation</th>
                        <th>3</th>
                        <td>
                          <div className="input-group mb-3">
                            <select
                      ...
                      <tr>
                        <th>Renewable Energy Systems</th>
                        <th>3</th>
                        <td>
                          <div className="input-group mb-3">
                            <select
                      ...
                      <tr>
                        <th>Career Competency Development</th>
                        <th>0</th>
                        <td>
                          <div className="input-group mb-3">
                            <select
