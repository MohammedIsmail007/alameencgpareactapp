...
const Mechsem5r2020 = () => {
  ...
  const fetchRegnos = async () => {
    try {
      const response = await axios.get(
        "https://alameencgpareactappserver.onrender.com/mechsem4"
  ...
  const fetchStudentData = async (regno) => {
    ...
    try {
      const response = await axios.get(
        `https://alameencgpareactappserver.onrender.com/mechsem4/${regno}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://alameencgpareactappserver.onrender.com/mechsem5",
        data
      );
