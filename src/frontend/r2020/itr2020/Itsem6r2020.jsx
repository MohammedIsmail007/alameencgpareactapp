...
const Itsem6r2020 = () => {
  ...
  const fetchRegnos = async () => {
    try {
      const response = await axios.get(
        "https://alameencgpareactappserver.onrender.com/itsem5"
  ...
  const fetchStudentData = async (regno) => {
    ...
    try {
      const response = await axios.get(
        `https://alameencgpareactappserver.onrender.com/itsem5/${regno}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://alameencgpareactappserver.onrender.com/itsem6",
        data
      );
