...
const Ecesem5r2020 = () => {
  ...
  const fetchRegnos = async () => {
    try {
      const response = await axios.get(
        "https://alameencgpareactappserver.onrender.com/ecesem4"
  ...
  const fetchStudentData = async (regno) => {
    ...
    try {
      const response = await axios.get(
        `https://alameencgpareactappserver.onrender.com/ecesem4/${regno}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://alameencgpareactappserver.onrender.com/ecesem5",
        data
      );
