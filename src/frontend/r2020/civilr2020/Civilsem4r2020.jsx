...
const Civilsem4r2020 = () => {
  ...
  function get4() {
    var ses = document.getElementsByClassName("selectcivilsem4");
    var creditregcivil4 = 0; // Initialize creditreg to 0
    civilsum4 = 0; // Ensure sum1 is reset
    civilgpa4 = []; // Ensure gpa1 is reset

    for (var i = 0; i < ses.length; i++) {
      var val4 = ses[i].options[ses[i].selectedIndex].value;
      civilgpa4.push(civilvale4[val4] * civilsem4[i]);
      civilsum4 += civilvale4[val4] * civilsem4[i];

      // Update creditreg only if the selected option is not "other"
      if (val4 !== "other") {
        creditregcivil4 += civilsem4[i];
      }
    }

    // Calculate the GPA
    mulcivilsum4 = civilsum4;
    //const prevcredit = parseFloat(studentData.prevcredit);

    ////console.log(creditreg);
    civiltot4 =
      creditregcivil4 === 0 ? 0 : (mulcivilsum4 / creditregcivil4).toFixed(3);

    // Update the form fields
    document.getElementById("totcreditregcivil4").value = creditregcivil4;
    document.getElementById("totsumvaluecivil4").value = civilsum4;
    document.getElementById("civilgpa4").value = civiltot4;
  }

  // //console.log(studentData.totcredit);
  function sem4cgpacalc() {
    const prevcredit = document.getElementById("civilprevcredit4").value;
    const sem3credit =
      parseFloat(studentData.civiltotcredit) + parseFloat(prevcredit);
    const sem3totsum = parseFloat(studentData.civiltotsum);
    const sem4totsum = document.getElementById("totsumvaluecivil4").value;
    const sem4credit = document.getElementById("totcreditregcivil4").value;
    ...
    document.getElementById("totccivilgpa4").value = cgpasem4total.toFixed(2);
    ...
    //console.log(cgpasem4total);
    document.getElementById("totalcivilsum4").value =
      parseFloat(totalsum).toFixed(3);
    document.getElementById("totalcreditcivil4").value = totalcredit;
  }
