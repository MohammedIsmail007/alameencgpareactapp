...
const Civilsem3r2020 = () => {
  ...
  var civiltot3 = 0;
  var mulcivilsum3 = 0;
  var creditregcivil3 = 0;
  function get3() {
    var ses = document.getElementsByClassName("selectcivilsem3");
    var creditregcivil3 = 0; // Initialize creditreg to 0
    civilsum3 = 0; // Ensure sum1 is reset
    civilgpa3 = []; // Ensure gpa1 is reset

    for (var i = 0; i < ses.length; i++) {
      var val2 = ses[i].options[ses[i].selectedIndex].value;
      civilgpa3.push(civilvale3[val2] * civilsem3[i]);
      civilsum3 += civilvale3[val2] * civilsem3[i];

      // Update creditreg only if the selected option is not "other"
      if (val2 !== "other") {
        creditregcivil3 += civilsem3[i];
      }
    }

    // Calculate the GPA
    mulcivilsum3 = civilsum3;
    //const prevcredit = parseFloat(studentData.prevcredit);

    ////console.log(creditreg);
    civiltot3 =
      creditregcivil3 === 0 ? 0 : (mulcivilsum3 / creditregcivil3).toFixed(3);

    // Update the form fields
    document.getElementById("totcreditregcivil3").value = creditregcivil3;
    document.getElementById("totsumvaluecivil3").value = civilsum3;
    document.getElementById("civilgpa3").value = civiltot3;
  }

  // //console.log(studentData.totcredit);
  function sem3cgpacalc(lateralcheck) {
    if (lateralcheck == "yes") {
      const prevcredit = document.getElementById("civilprevcredit3").value;
      const sem2credit = 0 + parseFloat(prevcredit);
      const sem2totsum = 0;
      const sem3totsum = document.getElementById("totsumvaluecivil3").value;
      const sem3credit = document.getElementById("totcreditregcivil3").value;
      ...
      document.getElementById("totccivilgpa3").value = cgpasem2total.toFixed(2);
      ...
      // //console.log(cgpasem2total);
      document.getElementById("totalcivilsum3").value =
        parseFloat(totalsum).toFixed(3);
      document.getElementById("totalcreditcivil3").value = totalcredit;
    } else {
      const prevcredit = document.getElementById("civilprevcredit3").value;
      const sem2credit =
