...
const Sandhhome = () => {
  ...
  function sem1cgpacalc() {
    ...
    const roundsem1cgpa = parseFloat(semcgpa1).toFixed(2);
    document.getElementById("totcgpa1").value = roundsem1cgpa;
  }
      ...
      <div className="container flex flex-wrap justify-center flex-col">
        ...
        <div className="container">
          ...
          <div className=" flex flex-wrap gap-2 m-5 p-5 flex-col  justify-center">
            ...
            <br />
            {/* CGPA CALCULATION FOR SECOND SEM STARTS-------------------------------- */}
            ...
            {/* RELOAD AND PRINT BUTTON COMMON FOR ALL  */}
          </div>
        </div>
      </div>
      <div>
