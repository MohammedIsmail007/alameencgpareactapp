...
const Eceeeesem2r2020 = () => {
  ...
  function get2() {
    var ses = document.getElementsByClassName("selecteceeee");
    ...
    for (var i = 0; i < ses.length; i++) {
      ...
      gpa2.push(vale2[val2] * eceeee2[i]);
      sum2 += vale2[val2] * eceeee2[i];

      // Update creditreg only if the selected option is not "other"
      if (val2 !== "other") {
        creditreg2 += eceeee2[i];
      }
    }
  ...
  function eceeeecgpacalc() {
    const sem1credit =
      parseFloat(studentData.totcredit) + parseFloat(studentData.prevcredit);
    const sem1totsum = parseFloat(studentData.totsum);
    const eceeeetotsum = document.getElementById("totsumvalue2").value;
    const eceeeecredit = document.getElementById("totcreditreg2").value;

    const totalsum =
      parseFloat(sem1totsum) +
      parseFloat(eceeeetotsum) +
      parseFloat(arreartotalgrades);
    const totalcredit =
      parseFloat(sem1credit) +
      parseFloat(eceeeecredit) +
      parseFloat(arreartotalcreditscore);
    const cgpaeceeeetotal = totalsum / totalcredit;
    document.getElementById("totcgpa2").value = cgpaeceeeetotal.toFixed(2);
    // //console.log(sem1credit);
    // //console.log(sem1totsum);
    // //console.log(eceeeetotsum);
    // //console.log(arreartotalcreditscore);
    // //console.log(arreartotalgrades);
    // //console.log(totalsum);
    // //console.log(totalcredit);
    // //console.log(cgpaeceeeetotal);
    // //console.log(arreartotalcreditscore);
    // //console.log(arreartotalgrades);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/eceeee", data);
...
export default Eceeeesem2r2020;
