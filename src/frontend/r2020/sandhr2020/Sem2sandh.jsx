...
const Sem2sandh = () => {
  ...
  var sem22 = [4, 3, 3, 3, 1.5, 1.5, 1.5, 0, 1];
  var sum2 = 0;
  var gpa2 = [];
  var tot2 = 0;
  var mulsum2 = 0;
  ...
  function get2() {
    var ses = document.getElementsByClassName("selectsem2");
    ...
    for (var i = 0; i < ses.length; i++) {
      ...
      gpa2.push(vale2[val2] * sem22[i]);
      sum2 += vale2[val2] * sem22[i];
  ...
  function sem2cgpacalc() {
    ...
    const sem2totsum = document.getElementById("totsumvalue2").value;
    const sem2credit = document.getElementById("totcreditreg2").value;
    ...
    document.getElementById("totcgpa2").value = cgpasem2total.toFixed(2);
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="input-group m-3 p-3">
                            <select
                              className="form-select selectsem2"
